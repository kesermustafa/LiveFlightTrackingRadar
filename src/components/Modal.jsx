        ...
        <div className="modal-outer">
            <div className="modal-inner">
                ...
                {isLoading ? <Loading/> : error ? <Error msg={error}/> : (
                    ...
                    isVIP ? <h3 className='error-container'>Ozel Ucus</h3> :
                    info &&
                    <div className='info '>
                        <div className="modal-header mb-4 d-flex justify-content-between align-items-center">
                            <div className='d-flex gap-3 align-items-center justify-content-center'>
                                <Tooltips desings={'text-warning fs-5'} title={info.identification.callsign}
                                          tooltipText={"Call Sing"}/>
                                <Tooltips desings={'text-info fs-6'} title={info.identification.number.default}
                                          tooltipText={"Ucus Kodu"}/>
                                <Tooltips desings={'text-success fw-bold fs-6'} title={info.aircraft?.registration}
                        ...
                        <div className='info-wrapper'>
                            <div className='d-flex  flex-column gap-2'>
                                ...
                                <Splide className='overflow-hidden rounded' options={{pagination: false}}>
                                    {images.map((image, index) => (
                                        <SplideSlide key={index}>
                                            <img className='info-img rounded' alt={info?.airline?.name} src={image.src}/>
                                        </SplideSlide>
                                    ))}
                                </Splide>
                                ...
                                <div
                                    ...
                                    <div
                                        ...
                                        <a className='text-decoration-none text-white text-truncate '
                                           href={info.airport?.origin?.website} target='_blank'>
                                            <span className=' '>
                                    ...
                                    <div
                                        ...
                                        <a className='text-decoration-none text-white text-truncate '
                                           href={info.airport?.destination?.website} target='_blank'>
                                            <span className=''>
                                ...
                                <div className='d-flex w-100 justify-content-between '>
                                    <div
                                        className='d-flex border justify-content-center align-items-center flex-column gap-1 w-100 '>
                                        <p className='w-100 text-center pt-2'>
                                            <GiAirplaneDeparture color="dodgerblue" size='28px'/> Kalkis
                                        </p>
                                    ...
                                    <div
                                        className='d-flex border justify-content-center align-items-center flex-column gap-1 w-100'>
                                        <p className='w-100 text-center pt-2'>
                                            <GiAirplaneArrival color="green" size='28px'/> Varis
                                        </p>
